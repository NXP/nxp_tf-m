...
#define __FLASH_LAYOUT_H__
 ...
 /* Flash layout on MCXW23 without BL2:
 *
...
/* a multiple of FLASH_AREA_IMAGE_SECTOR_SIZE (8 kB)*/
#define FLASH_PS_AREA_SIZE              (FLASH_AREA_IMAGE_SECTOR_SIZE * 2) /* 16 KB*/
...
/* a multiple of FLASH_AREA_IMAGE_SECTOR_SIZE (8 kB)*/
#define FLASH_ITS_AREA_SIZE             (FLASH_AREA_IMAGE_SECTOR_SIZE * 2) /* 16 KB*/
...
#define S_RAM_ALIAS_BASE    (0x30004000)
#define NS_RAM_ALIAS_BASE   (0x20004000)
