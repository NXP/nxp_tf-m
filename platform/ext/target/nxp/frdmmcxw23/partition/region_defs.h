...
#define NS_HEAP_SIZE            (0x0000200)
#define NS_STACK_SIZE           (0x0000100)
...
/* 60 KB ram is for secure application and rest (112-56) 56 KB Ram is available for non-secure apps*/
#define S_DATA_SIZE                     (56 * 1024)
#define S_DATA_LIMIT                    (S_DATA_START + S_DATA_SIZE - 1)

/* Size of vector table: 79 interrupt handlers(see g_pfnVectors definition) + 4 bytes MPS initial value ((79*4 + 4) = 320 = 0x140) */
#define S_CODE_VECTOR_TABLE_SIZE    (0x140)
...
/* Flash is divided into 64 kB sub-regions. Each sub-region can be assigned individual
security tier by programing corresponding registers in secure AHB controller.*/
#define FLASH_SUBREGION_SIZE    (0x10000)     /* 64 kB */
