...
#define S_CTCM_ALIAS(x)  (S_CTCM_ALIAS_BASE + (x))
#define NS_CTCM_ALIAS(x) (NS_CTCM_ALIAS_BASE + (x))
...
//#define S_DATA_SIZE     ((TOTAL_RAM_SIZE / 2) + 0x8000)
/* Fixed ram size allocation for secure work (112 KB + 32 KB= 144 KB RAM for secure size ). Picked up from kw47/MCXW72 secure allocation*/
#define S_DATA_SIZE     ((0x1C000) + 0x8000)
