...
int32_t mpc_init_cfg(void)
{
    ...
    */
    ...
    /* Flash region has 1 MB of Flash and 2 x 512 KB flash block instances. It is divided into 32 sub-regions (sector). Each flash sub-regions (sector) is 32 kbytes. */
    /* 0x0000 0000 to 0x000F FFFF 1 MB
...
int32_t ppc_init_cfg(void)
{
	...
	AHBSC_AIPS_BRIDGE_GROUP3_MEM_RULE1_QDC(0x0U);
