...
/*
 * RT700 workaround:
 * CMSE veneers are physically in RAM but must be called through
 * the non-secure RAM alias.
 *
 * Keep the same offset currently used after ER_CODE_SRAM.
 */
#define VENEER_PLACE_IN_SRAM     (1)

#define NSC_VENEER_START         (0x1000FC00)
#define NSC_VENEER_SLOT_SIZE     (0x380)

#define RAM_VENEER_OFFSET        (S_RAM_CODE_SIZE - NSC_VENEER_SLOT_SIZE)
#define CMSE_VENEER_REGION_SIZE  (NSC_VENEER_SLOT_SIZE)
...
#define M_BOOT_FLASH_CONF_START     (0x38000000)
