...
// #define K4_FLASH_ROMAPI
 ...
 /* Flash layout on KW45Z without BL2:
 *
...
#define FLASH_AREA_PROGRAM_SIZE             (16)		/* Minimum size of program operation */

/* FLASH size */
#define FLASH_TOTAL_SIZE                    (1024 * 1024)    /* 1 MB flash. */
...
#define TFM_HAL_PS_FLASH_AREA_ADDR      (FLASH_BASE_S + FLASH_PS_AREA_OFFSET)
...
#define TFM_HAL_ITS_FLASH_AREA_ADDR    (FLASH_BASE_S + FLASH_ITS_AREA_OFFSET)
...
#define TFM_OTP_NV_COUNTERS_AREA_ADDR   (FLASH_BASE_S + FLASH_OTP_NV_COUNTERS_AREA_OFFSET)
...
#define RESERVED_RAM_SIZE   (0x00004000)  /* Reserved SRAM0(16KB) for ROM API usage */
#else
#define RESERVED_RAM_SIZE   (0x00000000)
#endif

#define TOTAL_ROM_SIZE      FLASH_TOTAL_SIZE
#define TOTAL_RAM_SIZE      (0x0001C000 - RESERVED_RAM_SIZE)     /* TCM - System. 112 KB RAM for data (without TCM for code)*/
