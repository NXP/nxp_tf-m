...
/* Flash is divided into 16 kB sub-regions. Each sub-region can be assigned individual
security tier by programing corresponding registers in secure AHB controller */
/* Region 0: 512 KB (32 * 16 KB). */
                  
#define FLASH_REGION0_SUBREGION_NUMBER  (32)
#define FLASH_REGION0_SUBREGION_SIZE    (1024 * 16)      /* 16 kB */
#define FLASH_REGION0_SIZE              (FLASH_REGION0_SUBREGION_NUMBER * FLASH_REGION0_SUBREGION_SIZE)

/* Region 1: 32 KB (4 * 8 KB) */
#define FLASH_REGION1_SUBREGION_NUMBER  (4)  
#define FLASH_REGION1_SUBREGION_SIZE    (1024 * 8)            /* 8 kB */
#define FLASH_REGION1_SIZE              (FLASH_REGION1_SUBREGION_NUMBER * FLASH_REGION1_SUBREGION_SIZE)     /* 4 MB */
/* Region 2: 8 KB (4 * 2 KB) */
#define FLASH_REGION2_SUBREGION_NUMBER  (4)  
#define FLASH_REGION2_SUBREGION_SIZE    (1024 * 2)       /* 2 kB */
#define FLASH_REGION2_SIZE              (FLASH_REGION2_SUBREGION_NUMBER * FLASH_REGION2_SUBREGION_SIZE)     /* 8 MB */
                          
/* RAM is divided into 2 kB sub-regions. Each sub-region can be assigned individual
security tier by programing corresponding registers in secure AHB controller. */
#define DATA_SUBREGION_SIZE 0x800      /* 2 KB*/
...
/* Code SRAM area */
#define S_RAM_CODE_SIZE          (0x4000) /* SRAM X region - 16 KB*/
