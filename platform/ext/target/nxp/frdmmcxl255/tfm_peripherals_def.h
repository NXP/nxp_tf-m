...
#define CTIMER_CLK_ATTACH       (kFRO_HF_DIV_to_CTIMERg1)       /* Use 16 MHz clock */
#define CTIMER_CLK_DIVIDE       (kCLOCK_DivCtimer1Clk)
...
#define CTIMER_NS_CLK_ATTACH    (kFRO_HF_DIV_to_CTIMERg1)       /* Use 16 MHz clock */
#define CTIMER_NS_CLK_DIVIDE    (kCLOCK_DivCtimer2Clk)
