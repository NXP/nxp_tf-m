...
/* FLASH size */
#define FLASH_TOTAL_SIZE                (1024 * 1024 * 64)       /* XSPI1: 64 MBytes of physical Flash memory */
...
/* 0x08000000 is the XSPI1 memory-mapped AHB address */
#define S_ROM_ALIAS_BASE    (0x18000000)
#define NS_ROM_ALIAS_BASE   (0x08000000)

/* Use SRAM memory to store RW data */
#define S_RAM_ALIAS_BASE    (0x30080000)    /* Shared RAM via the CM33 data bus (secure access). */
#define NS_RAM_ALIAS_BASE   (0x20080000)    /* Shared RAM via the CM33 data bus (non-secure access). */
