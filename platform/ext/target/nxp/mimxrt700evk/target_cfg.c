        ...
        else /* == Region 1 == */
        {
            ...
            for (ns_region_id = ns_region_start_id; ns_region_id < ns_region_end_id; ns_region_id++)
            {
                if (ns_region_id < FLASH_REGION1_SUBREGION_NUMBER)
                {
                    ...
                    AHBSC0->XSPI1_REGION1_4_MEM_RULE[0].XSPI1_REGION_MEM_RULE0 &= ~(0xF << (ns_region_id * 4));
                }
                else /* == Region 2 == */
                {
                    if (ns_region_start_id > FLASH_REGION1_SUBREGION_NUMBER)
                    ...
                    for (ns_region_id = ns_region_start_id; ns_region_id < ns_region_end_id; ns_region_id++) 
                    {
                        if (ns_region_id < FLASH_REGION2_SUBREGION_NUMBER)
                        {
                            ...
                            AHBSC0->XSPI1_REGION1_4_MEM_RULE[1].XSPI1_REGION_MEM_RULE0 &= ~(0xF << (ns_region_id * 4));
                        }
                        else /* == Region 3 == */
                        {
                            ...
                            for (ns_region_id = ns_region_start_id; ns_region_id < ns_region_end_id; ns_region_id++) 
                            {
                                if (ns_region_id < FLASH_REGION3_SUBREGION_NUMBER)
                                {
                                    ...
                                    AHBSC0->XSPI1_REGION1_4_MEM_RULE[2].XSPI1_REGION_MEM_RULE0 &= ~(0xF << (ns_region_id * 4));
                                }
                                else /* == Region 4 == */
                                {
                                         ...
                                         ns_region_id++)
                                    {
                                        if (ns_region_id < FLASH_REGION4_SUBREGION_NUMBER)
                                        {
                                            ...
                                            AHBSC0->XSPI1_REGION1_4_MEM_RULE[3].XSPI1_REGION_MEM_RULE0 &= ~(0xF << (ns_region_id * 4));
                                        }
                                        else
                                        {
                                            break;
