...
DEFAULT_IRQ_HANDLER(OR_IRQHandler)
DEFAULT_IRQ_HANDLER(EDMA_0_CH0_IRQHandler) 
DEFAULT_IRQ_HANDLER(EDMA_0_CH1_IRQHandler)
DEFAULT_IRQ_HANDLER(EDMA_0_CH2_IRQHandler) 
DEFAULT_IRQ_HANDLER(EDMA_0_CH3_IRQHandler)
DEFAULT_IRQ_HANDLER(EDMA_0_CH4_IRQHandler)
DEFAULT_IRQ_HANDLER(EDMA_0_CH5_IRQHandler)
DEFAULT_IRQ_HANDLER(EDMA_0_CH6_IRQHandler)
DEFAULT_IRQ_HANDLER(EDMA_0_CH7_IRQHandler)
DEFAULT_IRQ_HANDLER(EDMA_0_CH8_IRQHandler) 
DEFAULT_IRQ_HANDLER(EDMA_0_CH9_IRQHandler)
DEFAULT_IRQ_HANDLER(EDMA_0_CH10_IRQHandler) 
DEFAULT_IRQ_HANDLER(EDMA_0_CH11_IRQHandler)
DEFAULT_IRQ_HANDLER(EDMA_0_CH12_IRQHandler)
DEFAULT_IRQ_HANDLER(EDMA_0_CH13_IRQHandler)
DEFAULT_IRQ_HANDLER(EDMA_0_CH14_IRQHandler)
DEFAULT_IRQ_HANDLER(EDMA_0_CH15_IRQHandler)
DEFAULT_IRQ_HANDLER(GPIO00_IRQHandler)
DEFAULT_IRQ_HANDLER(GPIO01_IRQHandler)
DEFAULT_IRQ_HANDLER(GPIO10_IRQHandler)
DEFAULT_IRQ_HANDLER(GPIO11_IRQHandler)
DEFAULT_IRQ_HANDLER(GPIO20_IRQHandler)                             
DEFAULT_IRQ_HANDLER(GPIO21_IRQHandler)                             
DEFAULT_IRQ_HANDLER(GPIO30_IRQHandler)                            
DEFAULT_IRQ_HANDLER(GPIO31_IRQHandler)                             
DEFAULT_IRQ_HANDLER(GPIO40_IRQHandler)                            
DEFAULT_IRQ_HANDLER(GPIO41_IRQHandler)                             
DEFAULT_IRQ_HANDLER(GPIO50_IRQHandler)                             
DEFAULT_IRQ_HANDLER(GPIO51_IRQHandler)
...
DEFAULT_IRQ_HANDLER(LP_FLEXCOMM0_IRQHandler)                       
DEFAULT_IRQ_HANDLER(LP_FLEXCOMM1_IRQHandler)                       
DEFAULT_IRQ_HANDLER(LP_FLEXCOMM2_IRQHandler)                       
DEFAULT_IRQ_HANDLER(LP_FLEXCOMM3_IRQHandler)                       
DEFAULT_IRQ_HANDLER(LP_FLEXCOMM4_IRQHandler)                       
DEFAULT_IRQ_HANDLER(LP_FLEXCOMM5_IRQHandler)                       
DEFAULT_IRQ_HANDLER(LP_FLEXCOMM6_IRQHandler)                       
DEFAULT_IRQ_HANDLER(LP_FLEXCOMM7_IRQHandler)                       
DEFAULT_IRQ_HANDLER(LP_FLEXCOMM8_IRQHandler)                       
DEFAULT_IRQ_HANDLER(LP_FLEXCOMM9_IRQHandler)                       
DEFAULT_IRQ_HANDLER(ADC0_IRQHandler)                               
DEFAULT_IRQ_HANDLER(ADC1_IRQHandler)                               
DEFAULT_IRQ_HANDLER(PINT0_IRQHandler)                              
DEFAULT_IRQ_HANDLER(PDM_EVENT_IRQHandler)                          
DEFAULT_IRQ_HANDLER(Reserved65_IRQHandler)                         
DEFAULT_IRQ_HANDLER(USB0_FS_IRQHandler)                            
DEFAULT_IRQ_HANDLER(USB0_DCD_IRQHandler)                           
DEFAULT_IRQ_HANDLER(RTC_IRQHandler)                                
DEFAULT_IRQ_HANDLER(SMARTDMA_IRQHandler)                           
...
DEFAULT_IRQ_HANDLER(SAI0_IRQHandler)                               
...
DEFAULT_IRQ_HANDLER(Reserved81_IRQHandler)                         
DEFAULT_IRQ_HANDLER(USB1_HS_PHY_IRQHandler)                        
DEFAULT_IRQ_HANDLER(USB1_HS_IRQHandler)                            
...
DEFAULT_IRQ_HANDLER(ELS_IRQHandler)                                
DEFAULT_IRQ_HANDLER(PKC_IRQHandler)                                
DEFAULT_IRQ_HANDLER(PUF_IRQHandler)                                
DEFAULT_IRQ_HANDLER(PQ_IRQHandler)                                 
DEFAULT_IRQ_HANDLER(EDMA_1_CH0_IRQHandler)                         
DEFAULT_IRQ_HANDLER(EDMA_1_CH1_IRQHandler)                         
DEFAULT_IRQ_HANDLER(EDMA_1_CH2_IRQHandler)                         
DEFAULT_IRQ_HANDLER(EDMA_1_CH3_IRQHandler)                         
DEFAULT_IRQ_HANDLER(EDMA_1_CH4_IRQHandler)                         
DEFAULT_IRQ_HANDLER(EDMA_1_CH5_IRQHandler)                         
DEFAULT_IRQ_HANDLER(EDMA_1_CH6_IRQHandler)                         
DEFAULT_IRQ_HANDLER(EDMA_1_CH7_IRQHandler)                         
DEFAULT_IRQ_HANDLER(EDMA_1_CH8_IRQHandler)                         
DEFAULT_IRQ_HANDLER(EDMA_1_CH9_IRQHandler)                         
DEFAULT_IRQ_HANDLER(EDMA_1_CH10_IRQHandler)                        
DEFAULT_IRQ_HANDLER(EDMA_1_CH11_IRQHandler)                        
DEFAULT_IRQ_HANDLER(EDMA_1_CH12_IRQHandler)                        
DEFAULT_IRQ_HANDLER(EDMA_1_CH13_IRQHandler)                        
DEFAULT_IRQ_HANDLER(EDMA_1_CH14_IRQHandler)                        
DEFAULT_IRQ_HANDLER(EDMA_1_CH15_IRQHandler)                        
DEFAULT_IRQ_HANDLER(CDOG0_IRQHandler)                              
DEFAULT_IRQ_HANDLER(CDOG1_IRQHandler)                              
DEFAULT_IRQ_HANDLER(I3C0_IRQHandler)                               
DEFAULT_IRQ_HANDLER(I3C1_IRQHandler)                               
DEFAULT_IRQ_HANDLER(NPU_IRQHandler)                                
DEFAULT_IRQ_HANDLER(GDET_IRQHandler)                               
DEFAULT_IRQ_HANDLER(VBAT0_IRQHandler)                              
DEFAULT_IRQ_HANDLER(EWM0_IRQHandler)                               
DEFAULT_IRQ_HANDLER(TSI_END_OF_SCAN_IRQHandler)                    
DEFAULT_IRQ_HANDLER(TSI_OUT_OF_SCAN_IRQHandler)                    
DEFAULT_IRQ_HANDLER(EMVSIM0_IRQHandler)                            
DEFAULT_IRQ_HANDLER(EMVSIM1_IRQHandler)                            
...
DEFAULT_IRQ_HANDLER(FLEXPWM0_SUBMODULE0_IRQHandler)                
DEFAULT_IRQ_HANDLER(FLEXPWM0_SUBMODULE1_IRQHandler)                
DEFAULT_IRQ_HANDLER(FLEXPWM0_SUBMODULE2_IRQHandler)                
DEFAULT_IRQ_HANDLER(FLEXPWM0_SUBMODULE3_IRQHandler)                
DEFAULT_IRQ_HANDLER(FLEXPWM1_RELOAD_ERROR_IRQHandler)              
DEFAULT_IRQ_HANDLER(FLEXPWM1_FAULT_IRQHandler)                     
DEFAULT_IRQ_HANDLER(FLEXPWM1_SUBMODULE0_IRQHandler)                
DEFAULT_IRQ_HANDLER(FLEXPWM1_SUBMODULE1_IRQHandler)                
DEFAULT_IRQ_HANDLER(FLEXPWM1_SUBMODULE2_IRQHandler)                
DEFAULT_IRQ_HANDLER(FLEXPWM1_SUBMODULE3_IRQHandler)                
DEFAULT_IRQ_HANDLER(ENC0_COMPARE_IRQHandler)                       
DEFAULT_IRQ_HANDLER(ENC0_HOME_IRQHandler)                          
DEFAULT_IRQ_HANDLER(ENC0_WDG_SAB_IRQHandler)                       
...
DEFAULT_IRQ_HANDLER(ENC1_WDG_SAB_IRQHandler)                       
DEFAULT_IRQ_HANDLER(ENC1_IDX_IRQHandler)                           
DEFAULT_IRQ_HANDLER(ITRC0_IRQHandler)
DEFAULT_IRQ_HANDLER(BSP32_IRQHandler)
DEFAULT_IRQ_HANDLER(ELS_ERR_IRQHandler)
DEFAULT_IRQ_HANDLER(PKC_ERR_IRQHandler)
DEFAULT_IRQ_HANDLER(ERM_SINGLE_BIT_ERROR_IRQHandler)
DEFAULT_IRQ_HANDLER(ERM_MULTI_BIT_ERROR_IRQHandler)
DEFAULT_IRQ_HANDLER(FMU0_IRQHandler)
DEFAULT_IRQ_HANDLER(ETHERNET_IRQHandler)
DEFAULT_IRQ_HANDLER(ETHERNET_PMT_IRQHandler)
DEFAULT_IRQ_HANDLER(ETHERNET_MACLP_IRQHandler)
DEFAULT_IRQ_HANDLER(SINC_FILTER_IRQHandler)
DEFAULT_IRQ_HANDLER(LPTMR0_IRQHandler) 
DEFAULT_IRQ_HANDLER(LPTMR1_IRQHandler)
DEFAULT_IRQ_HANDLER(SCG_IRQHandler)
DEFAULT_IRQ_HANDLER(SPC_IRQHandler)
DEFAULT_IRQ_HANDLER(WUU_IRQHandler)
DEFAULT_IRQ_HANDLER(PORT_EFT_IRQHandler)
DEFAULT_IRQ_HANDLER(ETB0_IRQHandler)
DEFAULT_IRQ_HANDLER(SM3_IRQHandler)
DEFAULT_IRQ_HANDLER(TRNG0_IRQHandler)
DEFAULT_IRQ_HANDLER(WWDT0_IRQHandler)
DEFAULT_IRQ_HANDLER(WWDT1_IRQHandler)
DEFAULT_IRQ_HANDLER(CMC0_IRQHandler)
DEFAULT_IRQ_HANDLER(CTI0_IRQHandler)
/*----------------------------------------------------------------------------
