...
python tools/tfm_parse_manifest_list.py -m tools/tfm_manifest_list.yaml ../tf-m-tests/tests_reg/test/secure_fw/tfm_test_manifest_list.yaml -f tools/tfm_generated_file_list.yaml platform/ext/target/nxp/common/generated_file_list.yaml -c ./manifest_config.h -t %TFM_TEST_PATH% -o %TFM_OUTPUT_PATH%
