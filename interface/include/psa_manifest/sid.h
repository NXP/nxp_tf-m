...
#define IPC_SERVICE_TEST_CONNECTION_REFUSED_SID                    (0x0000F089U)
#define IPC_SERVICE_TEST_CONNECTION_REFUSED_VERSION                (1U)
...
#define SFN_TEST_CONNECTION_REFUSED_SID                            (0x0000F102U)
#define SFN_TEST_CONNECTION_REFUSED_VERSION                        (1U)
